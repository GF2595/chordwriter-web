...
import { ElementInfo, PageHeader } from 'components/common/PageHeader';
...
const HomePageContent: React.FC = () => {
    ...
    const buttons: ElementInfo[] = useMemo(
        ...
        [hasEditedSong, onCreateSong, onOpenSong, structureVisible/* , value */]
    );
...
export const Home: React.FC = () => {
    // TODO: вернуть меню-плейсхолдер (сейчас это undefined в качестве значения song)
    return (
        <Container>
            <EditorContextProvider song={{ author: '', songBody: [], title: '' }}>
                <HomePageContent />
            </EditorContextProvider>
        </Container>
    );
